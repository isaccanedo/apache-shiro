package com.isaccanedo.permissions.custom;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Ini ini = Ini.fromResourcePath(Main.class.getResource("/com/isaccanedo/shiro/permissions/custom/shiro.ini").getPath());
        realm.setIni(ini);
